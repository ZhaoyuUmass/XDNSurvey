...
const USER_CASE_STUDY_STRING_Q5 = "5. Please list your time availability to participate in our study. (For example, 12/31/2020, 10:00am-11:00am, EST)";
const USER_CASE_STUDY_STRING_Q5_EXPLANATION = "For example, 12/31/2020, 10:00am-11:00am, EST";
...
router.get('/', function(req, res) {
	res.render('question',
		{	title: 'Questionnaires',
			...
			q5_exp: USER_CASE_STUDY_STRING_Q5_EXPLANATION,
